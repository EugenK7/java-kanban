public class Main {
    ...
    public static void main(String[] args) {
        ...
        taskManager.updateTask(new Task
                ("нов имя зад 1", "нов. опис. зад. 1", TaskStatus.IN_PROGRESS), 1);

        taskManager.updateEpic(new Epic
                ("нов. назв эп. 1", "нов. опис. эп. 1", TaskStatus.DONE), 3);
        ...
        taskManager.updateSubTask(new Subtask
                ("Нов назв подздч 1", "нов опис пдздч1", TaskStatus.DONE, 3), 4);

        taskManager.updateSubTask(new Subtask
                ("Нов назв подздч 2", "нов опис пдздч2", TaskStatus.DONE, 3), 5);
